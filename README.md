...
Almost everything here is named after a plant. It started as a habit and
became a filing system.

- **[Trellis](https://github.com/Bolero-Dev/Trellis)** — Playwright vs.
...
`Swift` `SwiftUI` `Objective-C` `Python` `Playwright` `Selenium` `pytest`
`XCUITest` `Core Data` `GitHub Actions` `Git` `Jira` `Jenkins` `Xcode` `TestFlight`

## Contact

bolero-dev@proton.me
